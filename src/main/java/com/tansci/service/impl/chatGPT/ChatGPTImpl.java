...
//      单选题
            ...
            messages.add(new ChatGPTMessage("user", "请用" + questionLanguage + ",根据文章提出" + questionNum + "道单项选择题、答案、反馈(feedback)和考点(lo)"));
...
//      多选题
            messages.add(new ChatGPTMessage("system", "你是一名助手，旨在根据文章提出多项选择题、答案、反馈(feedback)和考点(lo)"));
...
//      简答题
            messages.add(new ChatGPTMessage("system", "你是个擅长根据文章提出问题的专家"));
            messages.add(new ChatGPTMessage("user", "请用" + questionLanguage + ",根据文章提出" + questionNum + "道简答题和考点(lo)"));
            messages.add(new ChatGPTMessage("assistant",
                    "以JSON格式返回,JSON包含一个questions数组，每个json对象包含title,lo."));
            messages.add(new ChatGPTMessage("user", prompt));
        }
        return messages;
    }
